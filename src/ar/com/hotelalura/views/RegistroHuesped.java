...
//GUARDAR HUESPED
				...
				var huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), Date.valueOf(fechaNacimiento),
						txtNacionalidad.getSelectedItem().toString(), telefonoInt, reservaIdInt);
