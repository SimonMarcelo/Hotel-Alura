...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaS.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				calcularEstadia(txtFechaE,txtFechaS);
			}
		});
		...
		txtValor.setBounds(88, 328, 43, 33);
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {
					...
					var reserva = new Reserva(java.sql.Date.valueOf(fechaEntrada), java.sql.Date.valueOf(fechaSalida),
	...
	private void calcularEstadia (JDateChooser txtFechaE, JDateChooser txtFechaS) {
